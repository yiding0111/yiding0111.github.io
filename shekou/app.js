...
(function () {
  ...
  var M = {
    ...
    sand:    lam(COL.sand),
    water:   (function () {
      var m = new THREE.MeshPhongMaterial({ color: COL.water, flatShading: true, shininess: 6, specular: 0x333333 });
      m.polygonOffset = true; m.polygonOffsetFactor = 1; m.polygonOffsetUnits = 1;
      return m;
    })(),
    pool:    lam(COL.pool),
  ...
  var ground = new THREE.Mesh(new THREE.PlaneGeometry(4200, 4200), M.ground);
  ...
  var waterGeo = new THREE.PlaneGeometry(3400, 1400, 96, 40);
  var water = new THREE.Mesh(waterGeo, M.water);
  water.rotation.x = -Math.PI / 2;
  water.position.set(0, -3.0, 140 + 700);
  S.add(water);
  plate(S, 3400, 55, 0, -2.85, 168, lam(0xcfdfe3), { t: 0.1 });   // lighter nearshore shallows
  ...
  (function () {
    ...
    var bodyI = new THREE.InstancedMesh(bodyG, bodyM, spots.length);
    var headI = new THREE.InstancedMesh(headG, headM, spots.length);
    var mtx = new THREE.Matrix4();
  ...
  (function () {
    ...
    T(0xf0e6d4, 0x555e6a); T(0xcfdfe3, 0x16242e); T(0xf6f4ee, 0x8b99a9);
  ...
  var WX = { on: false, dim: 0, fogAmt: 0, rain: null, timer: null, label: '' };
